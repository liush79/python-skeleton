...
def main(argv):
    ...
    config.read('./conf/python-config.cfg')
    print config.get('my-section', 'opt1')
    print config.get('my-section', 'opt2')
    print config.get('my-section', 'opt3')
